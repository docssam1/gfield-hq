...
## 역할
이미지를 분석해서 SVG 코드를 생성하고 GitHub에 push하는 작업자다.

---

## STEP 1. 아래 파일 3개를 먼저 읽어라 (GitHub MCP 사용)

### 파일 1 — tutor-scripts.js
```
repo: docssam1/Hyper-Focus-answer-Key
경로: premier-hyper-focus/data/tutor-scripts.js
URL: https://raw.githubusercontent.com/docssam1/Hyper-Focus-answer-Key/main/premier-hyper-focus/data/tutor-scripts.js
```
...
URL: https://raw.githubusercontent.com/docssam1/Hyper-Focus-answer-Key/main/premier-hyper-focus/data/sq-a.js
```
...
## STEP 2. 원본 이미지 확인 및 분류 검증 (Google Drive MCP 사용)
...
## STEP 4. GitHub push (GitHub MCP 사용)
